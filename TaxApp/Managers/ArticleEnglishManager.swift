...
class ArticleEnglishManager {
    ...
    //getArticleFromAPI
    static func getArticleEnglishFromAPI(menuEnglish: MenuEnglish,
        ...
        let menuEnglishIdString = String(menuEnglish.id)
        let url = URL(string: ConfigAPI.getArticlesEnglishString.appending(menuEnglishIdString))!
                ...
                for element in array {
                    if let tempElement = element as? [String: Any] {
                        ...
                        if let articleEnglish = getArticleEnglishByID(id: id, context:  moc)  {
                            articleEnglish.update(menuEnglishID: menuEnglish.id, dictionary: tempElement as NSDictionary)
                            //update
